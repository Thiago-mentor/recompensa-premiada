...
exports.getActiveRaffle = (0, https_1.onCall)(DEFAULT_CALLABLE_OPTS, async (request) => {
    ...
    return {
        ok: true,
        enabled: true,
        raffle: latestPublished ? raffleViewFromDoc(latestPublished) : null,
    };
});
